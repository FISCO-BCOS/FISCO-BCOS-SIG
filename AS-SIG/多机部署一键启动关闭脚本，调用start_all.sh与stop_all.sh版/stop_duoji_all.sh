...
expect "*$ssh_machine1_user*" {send "bash ~/fisco/$ssh_machine1_ip/stop_all.sh\r"}
...
expect "*$ssh_machine2_user*" {send "bash ~/fisco/$ssh_machine2_ip/stop_all.sh\r"}
...
expect "*$ssh_machine3_user*" {send "bash ~/fisco/$ssh_machine3_ip/stop_all.sh\r"}
...
expect "*$ssh_machine4_user*" {send "bash ~/fisco/$ssh_machine4_ip/stop_all.sh\r"}
