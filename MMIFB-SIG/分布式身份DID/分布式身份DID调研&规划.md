...
![可验证凭证流转模型](images/可验证凭证流转模型.JPEG) 
...
![分布式数字身份体系架构](images/分布式数字身份体系架构.PNG) 
...
![身份全生命周期流程图](images/身份全生命周期流程图.png) 
...
<center>图：百度baidu-身份全生命周期流程图</center>
